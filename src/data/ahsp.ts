...
export const AHSP_INFRA: AHSPTemplate[] = [
  // ══════════════════════════════════════════════════════════
  // PEKERJAAN INFRASTRUKTUR BERAT (JEMBATAN & BENDUNGAN)
  // ══════════════════════════════════════════════════════════
  {
    id: 'infra-001',
    category: 'Tanah & Pondasi',
    name: 'Pemancangan Tiang Pancang Beton (Spun Pile) Dia. 500mm',
    unit: 'm1',
    desc: 'Pondasi tiang beton bulat besar (paku bumi), ditanam pakai mesin pemukul biar jembatan nggak ambruk.',
    materials: [
      { name: 'Spun Pile Dia. 500mm', coeff: 1.05, unit: 'm1' },
      { name: 'Solar', coeff: 1.5, unit: 'liter' },
      { name: 'Minyak Pelumas', coeff: 0.1, unit: 'liter' },
    ],
    laborCoefficients: [
      { name: 'Pekerja', coeff: 0.3, unit: 'OH' },
      { name: 'Tukang Besi', coeff: 0.1, unit: 'OH' },
      { name: 'Operator Alat Berat', coeff: 0.05, unit: 'OH' },
      { name: 'Mandor', coeff: 0.02, unit: 'OH' },
    ],
    productivity: 10,
  },
  {
    id: 'infra-002',
    category: 'Struktur',
    name: 'Beton Ready Mix K-350 (Pier Jembatan / Spillway)',
    unit: 'm3',
    desc: 'Ngecor beton super kuat (K-350) buat pilar penyangga jembatan atau dinding bendungan, disemprot pakai mesin pompa.',
    materials: [
      { name: 'Beton K-350', coeff: 1.03, unit: 'm3' },
      { name: 'Sewa Concrete Pump', coeff: 0.02, unit: 'jam' },
    ],
    laborCoefficients: [
      { name: 'Pekerja', coeff: 1.5, unit: 'OH' },
      { name: 'Tukang Batu', coeff: 0.2, unit: 'OH' },
  ...
  },
  {
    id: 'infra-003',
    category: 'Struktur',
    name: 'Pemasangan Rangka Baja Profil WF (Jembatan / Sekolah)',
    unit: 'kg',
    desc: 'Ngerakit baja tebal (WF) pakai mesin derek (Crane) plus dilas full biar rangkanya kokoh badai.',
    materials: [
      { name: 'Baja WF', coeff: 1.05, unit: 'kg' },
      { name: 'Kawat Las', coeff: 0.04, unit: 'kg' },
      { name: 'Sewa Crane', coeff: 0.005, unit: 'jam' },
    ],
    laborCoefficients: [
      { name: 'Pekerja', coeff: 0.06, unit: 'OH' },
      { name: 'Tukang Las', coeff: 0.03, unit: 'OH' },
      { name: 'Kepala Tukang', coeff: 0.003, unit: 'OH' },
      { name: 'Mandor', coeff: 0.003, unit: 'OH' },
    ],
    productivity: 200,
  }
...
AHSP_TEMPLATES.push(...AHSP_INFRA);
const AHSP_SPECIALIZED: AHSPTemplate[] = [
  // --- RUMAH SAKIT ---
  {
    id: 'rs-001', category: 'Finishing & Pengecatan', name: 'Pemasangan Lantai Vinyl Anti-Bakteri (Rumah Sakit)', unit: 'm2', desc: 'Lantai khusus ruang operasi/ICU, gampang dibersihkan dan anti kuman.',
    materials: [{ name: 'Vinyl Sheet Anti-Bakteri', coeff: 1.05, unit: 'm2' }, { name: 'Lem Vinyl', coeff: 0.3, unit: 'kg' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 0.15, unit: 'OH' }, { name: 'Tukang Khusus', coeff: 0.35, unit: 'OH' }, { name: 'Mandor', coeff: 0.02, unit: 'OH' }],
    tags: ['Rumah Sakit']
  },
  {
    id: 'rs-002', category: 'Kusen, Pintu & Jendela', name: 'Pintu Berlapis Timbal (Ruang Radiologi/X-Ray)', unit: 'unit', desc: 'Pintu berat anti radiasi X-Ray.',
    materials: [{ name: 'Pintu Timbal (Lead Lined)', coeff: 1, unit: 'unit' }, { name: 'Engsel Heavy Duty', coeff: 3, unit: 'bh' }, { name: 'Handle Tarik', coeff: 1, unit: 'set' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 1, unit: 'OH' }, { name: 'Tukang Besi', coeff: 1.5, unit: 'OH' }, { name: 'Kepala Tukang', coeff: 0.1, unit: 'OH' }, { name: 'Mandor', coeff: 0.05, unit: 'OH' }],
    tags: ['Rumah Sakit']
  },
  {
    id: 'rs-003', category: 'Instalasi Air & Sanitasi', name: 'Instalasi Jaringan Gas Medis (O2, N2O, Vacuum)', unit: 'm', desc: 'Pipa tembaga standar medis.',
    materials: [{ name: 'Pipa Tembaga Gas Medis 1/2"', coeff: 1.05, unit: 'm' }, { name: 'Kawat Las Perak', coeff: 0.02, unit: 'kg' }],
    laborCoefficients: [{ name: 'Tukang Pipa Khusus', coeff: 0.5, unit: 'OH' }, { name: 'Pekerja', coeff: 0.3, unit: 'OH' }],
    tags: ['Rumah Sakit']
  },

  // --- SEKOLAH ---
  {
    id: 'skl-001', category: 'Finishing & Pengecatan', name: 'Pengecatan Dinding Anti-Coret (Sekolah)', unit: 'm2', desc: 'Cat epoxy mudah dibersihkan dari spidol/coretan.',
    materials: [{ name: 'Cat Anti-Coret (Epoxy Water Based)', coeff: 0.25, unit: 'kg' }, { name: 'Plamir', coeff: 0.1, unit: 'kg' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 0.02, unit: 'OH' }, { name: 'Tukang Cat', coeff: 0.063, unit: 'OH' }, { name: 'Mandor', coeff: 0.002, unit: 'OH' }],
    tags: ['Gedung Sekolah']
  },
  {
    id: 'skl-002', category: 'Lain-lain', name: 'Pemasangan Papan Tulis Kapur / Whiteboard Built-in', unit: 'm2', desc: 'Papan tulis tertanam permanen di dinding kelas.',
    materials: [{ name: 'Multiplek 9mm', coeff: 1.1, unit: 'm2' }, { name: 'HPL Whiteboard', coeff: 1.1, unit: 'm2' }, { name: 'Lem Kuning', coeff: 0.4, unit: 'kg' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 0.1, unit: 'OH' }, { name: 'Tukang Kayu', coeff: 0.3, unit: 'OH' }],
    tags: ['Gedung Sekolah']
  },

  // --- JEMBATAN ---
  {
    id: 'jbt-001', category: 'Struktur', name: 'Erection Girder Baja Prategang (Jembatan)', unit: 'ton', desc: 'Pengangkatan dan pemasangan gelagar baja pakai crane.',
    materials: [{ name: 'Baja Girder Profil (Pabrikasi)', coeff: 1.02, unit: 'ton' }, { name: 'Baut HTB', coeff: 10, unit: 'bh' }, { name: 'Sewa Mobile Crane 50T', coeff: 2, unit: 'jam' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 0.5, unit: 'OH' }, { name: 'Tukang Erection', coeff: 0.3, unit: 'OH' }, { name: 'Mandor', coeff: 0.05, unit: 'OH' }],
    tags: ['Infrastruktur Jembatan']
  },
  {
    id: 'jbt-002', category: 'Struktur', name: 'Pemasangan Elastomeric Bearing Pad', unit: 'bh', desc: 'Karet penahan getaran antara pilar dan gelagar.',
    materials: [{ name: 'Elastomeric Bearing Pad (Karet Baja)', coeff: 1, unit: 'bh' }, { name: 'Epoxy Grout', coeff: 5, unit: 'kg' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 0.1, unit: 'OH' }, { name: 'Tukang Batu', coeff: 0.1, unit: 'OH' }],
    tags: ['Infrastruktur Jembatan']
  },
  {
    id: 'jbt-003', category: 'Finishing & Pengecatan', name: 'Lapis Aspal Beton (AC-WC) Jembatan', unit: 'ton', desc: 'Aspal jalan di atas pelat jembatan.',
    materials: [{ name: 'Aspal Hotmix AC-WC', coeff: 1.02, unit: 'ton' }, { name: 'Tack Coat (Aspal Cair)', coeff: 0.3, unit: 'liter' }],
  ...
  // --- BENDUNGAN ---
  {
    id: 'bdg-001', category: 'Tanah & Pondasi', name: 'Galian Batu Keras dengan Blasting (Bendungan)', unit: 'm3', desc: 'Galian pondasi dam memecah batu pakai peledak.',
    materials: [{ name: 'Dinamit / Bahan Peledak', coeff: 0.5, unit: 'kg' }, { name: 'Detonator', coeff: 0.5, unit: 'bh' }],
    laborCoefficients: [{ name: 'Pekerja Khusus (Blaster)', coeff: 0.2, unit: 'OH' }, { name: 'Pekerja', coeff: 0.5, unit: 'OH' }, { name: 'Mandor', coeff: 0.05, unit: 'OH' }],
    tags: ['Infrastruktur Bendungan']
  },
  {
    id: 'bdg-002', category: 'Struktur', name: 'Pengecoran Beton Massa K-225 (Mass Concrete)', unit: 'm3', desc: 'Beton volume super besar untuk tubuh bendungan.',
    materials: [{ name: 'Semen Portland', coeff: 350, unit: 'kg' }, { name: 'Pasir Beton', coeff: 750, unit: 'kg' }, { name: 'Batu Pecah / Split', coeff: 1050, unit: 'kg' }, { name: 'Admixture Retarder', coeff: 2, unit: 'liter' }],
    laborCoefficients: [{ name: 'Pekerja', coeff: 1, unit: 'OH' }, { name: 'Tukang Batu', coeff: 0.2, unit: 'OH' }, { name: 'Mandor', coeff: 0.1, unit: 'OH' }],
    tags: ['Infrastruktur Bendungan']
  },
  {
...
AHSP_TEMPLATES.push(...AHSP_SPECIALIZED);
