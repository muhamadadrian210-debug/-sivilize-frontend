      ...
      <div className="bg-card border-t-2 border-primary shadow-2xl px-4 py-3">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="w-8 h-8 bg-primary/20 rounded-lg flex items-center justify-center hidden xs:flex">
              <TrendingUp size={16} className="text-primary" />
            </div>
            <div>
              <p className="text-[8px] xs:text-[10px] text-text-secondary uppercase font-bold tracking-widest leading-none">Item</p>
              <p className="text-white font-black text-xs xs:text-sm">{itemCount}</p>
            </div>
          </div>
          ...
          <div className="text-right flex-1 sm:flex-none">
            <p className="text-[8px] xs:text-[10px] text-text-secondary uppercase font-bold tracking-widest leading-none">Grand Total</p>
            <p className="text-primary font-black text-base xs:text-lg leading-tight">{formatCurrency(grandTotal)}</p>
          </div>
          ...
          {onScrollToTop && (
            <button
              ...
              className="shrink-0 w-8 h-8 xs:w-10 xs:h-10 bg-primary/10 border border-primary/20 rounded-xl flex items-center justify-center text-primary hover:bg-primary/20 transition-colors"
            >
              <ChevronUp size={18} />
            </button>
          )}
