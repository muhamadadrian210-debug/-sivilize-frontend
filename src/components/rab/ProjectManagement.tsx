...
const ProjectManagement = () => {
  const { projects, setProjects, setActiveTab } = useStore();
                    ...
                    <tr key={project.id} className="hover:bg-border/20 transition-all group">
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button className="p-2 hover:bg-border rounded-lg text-text-secondary hover:text-white transition-all" title="Lihat">
                            <Eye size={18} />
                          </button>
                          <button className="p-2 hover:bg-border rounded-lg text-text-secondary hover:text-white transition-all" title="Duplikat">
                            <Copy size={18} />
                          </button>
                          <button 
